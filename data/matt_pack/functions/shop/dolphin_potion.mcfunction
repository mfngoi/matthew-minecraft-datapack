...
execute if score @s Amount >= 16 Constant run give @s minecraft:potion{CustomPotionEffects:[{Id:30,Duration:72000,ShowParticles:0b}],CustomPotionColor:11201278,display:{Name:"\"Dolphin Potion\""}} 5
